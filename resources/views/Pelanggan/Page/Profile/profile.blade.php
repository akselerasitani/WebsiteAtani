...
@section('content')
    <div class="card border border-success mb-5" style="width:70%; margin: auto">
        <div class="card-body mb-5">
          ...
          <center><img class="profile-picture" src="{{ asset('user/' . $user->foto_user) }}" width="150px" height="150px"></center>
          <form class="form-inline">
            <div class="form-group row mt-5">
              <label for="inputPassword" class="col-sm-3 col-form-label">Nama Toko</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputPassword" value="Berkah Jaya" readonly>
              </div>
            </div>
            ...
            <div class="form-group row mt-3">
              ...
              <div class="col-sm-9">
                <input type="number" class="form-control" id="inputPassword" value="" readonly>
              </div>
            </div>
    
            <center><div class="col">
                <a href="" class="btn btn-light" style="margin-top: -8px; background-color: #77AC5C; color: white; width: 50%  " >Edit Profile</a>
            </div></center>
